...
try:
    decisions = pickle.load(open('model.pkl','rb'))
except FileNotFoundError:
    print("model.pkl not found in the current working directory.")
...
def predict():
	...
	if result == 1:
			result = "network is attacked"
	else:
		result = 'network is not attacked'
